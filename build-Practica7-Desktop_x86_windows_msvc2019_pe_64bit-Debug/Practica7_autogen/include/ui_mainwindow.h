...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        cOrdernar = new QComboBox(tab);
        cOrdernar->addItem(QString());
        cOrdernar->addItem(QString());
        cOrdernar->addItem(QString());
        cOrdernar->setObjectName("cOrdernar");
        cOrdernar->setGeometry(QRect(240, 10, 91, 24));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        cOrdernar->setItemText(0, QCoreApplication::translate("MainWindow", "Seleccionar...", nullptr));
        cOrdernar->setItemText(1, QCoreApplication::translate("MainWindow", "ID (Asc)", nullptr));
        cOrdernar->setItemText(2, QCoreApplication::translate("MainWindow", "Voltaje", nullptr));

        cOrdernar->setPlaceholderText(QCoreApplication::translate("MainWindow", "Ordenar...", nullptr));
